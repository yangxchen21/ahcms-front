<template>
  <el-tabs v-model="activeName" class="demo-tabs" @tab-change="changeTab">
    <el-tab-pane label="滚动新闻" name="rollNews" >
      <el-card
    ...
    <el-tab-pane label="新闻动态" name="dynNews">
      <el-card
        v-for="article in viewData.list"
        shadow="hover"
        class="list-item"
    ...
    <el-tab-pane label="竞赛活动" name="compeNews">
      <el-card
        v-for="article in viewData.list"
        shadow="hover"
        class="list-item"
    ...
    <el-tab-pane label="师资培训" name="trainNews">
      <el-card
        v-for="article in viewData.list"
        shadow="hover"
        class="list-item"
...
const activeName = ref('rollNews')
const viewData = reactive({
  currentType:ARTICLE_TYPES.ROLL_NEWS,
  title: '',
  list: [],
...
const changeTab=(tabName)=>{
  ...
  switch(tabName){
    case "rollNews":
      viewData.currentType=ARTICLE_TYPES.ROLL_NEWS
      break
    case "dynNews":
    viewData.currentType=ARTICLE_TYPES.DYN_NEWS
      break
    case "compeNews":
    viewData.currentType=ARTICLE_TYPES.CONTEST_NEWS
      break
    case "trainNews":
    viewData.currentType=ARTICLE_TYPES.TRAIN_NEWS
      break
  }
  getList(1)
}
